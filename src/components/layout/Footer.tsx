...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-purple/10 py-12 px-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="mt-6 text-sm max-w-xs">
            Trabalho de Conclusão de Curso de Moda - Apresentação de um portfólio criativo, visual e impactante.
          </p>
        </div>
        
        <div>
          <h3 className="text-xl font-bold uppercase mb-4">Navegação</h3>
          <div className="grid grid-cols-2 gap-2">
            <Link to="/" className="nav-link text-sm">INÍCIO</Link>
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-4 items-center">
            ...
            <img src="/by-vf.webp" alt="By Vic Falcão" className="w-8 h-8 object-contain" />
          </div>
        </div>
      </div>
